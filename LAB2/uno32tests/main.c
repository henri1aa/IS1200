...
//Lab 2 uppgift 5, på rad 76 skickar vi m till fun. i fun ökar vi m och sätter att gv är lika med m++. den globala variabeln gv ändras då i fun men m ändras inte.
//Pointer cp = 4 bytes för att chipkitet är 32-bit sys
//hus och addresser, 9 bytes för att null ska vara med som en signal för att avsluta strängen
//where is c funciton stored in memory? kolla manualen, fråga chat, program flash
